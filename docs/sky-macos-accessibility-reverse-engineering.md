...
This is the critical path for Insulator parity.
...
## Why Insulator's previous approximation failed
...
## Compatibility requirements for Insulator
...
1. Codex/Insulator remains the actual frontmost application throughout.
