//! Cross-platform stand-ins for the POSIX filesystem calls Insulator relies on.
//!
...
/// it.
///
/// Windows has no mode bits: the locations Insulator creates here live under the
